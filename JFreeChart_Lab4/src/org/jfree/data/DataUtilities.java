...
public abstract class DataUtilities {
	...
	/**
	 * Tests two arrays for equality. To be considered equal, the arrays must have
	 * exactly the same dimensions, and the values in each array must also match
	 * (two values that qre both NaN or both INF are considered equal in this test).
	 *
	...
	/**
	 * Returns the total of the values in one column of the supplied data table by
	 * taking only the row numbers in the array into account.
	 *
	 * @param data      the table of values (<code>null</code> not permitted).
	 * @param column    the column index (zero-based).
